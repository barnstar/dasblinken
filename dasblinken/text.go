...
// Render the string s at x, y with the given color function and luminance.
// 0,0 is Top Left.  We draw top-left to top-left.
func (l *LedMatrix) DrawString(
	x, y float64,
	s string,
	colorfunc func(float64, float64) RGB,
	lum float64) {
	dx := x
	for _, c := range s {
...
// Chacters include right hand spacing
var consoleFont = bitmapFont{
	s: size{8, 8},
	data: []byte{
		/*
